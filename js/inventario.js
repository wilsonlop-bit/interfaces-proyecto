...
function renderizarTabla() {
    ...
    // Ocultar columna ACCIONES en el thead si es Empleado
    const thAcciones = document.querySelector('thead tr th:last-child');
    if (thAcciones) thAcciones.style.display = admin ? '' : 'none';
